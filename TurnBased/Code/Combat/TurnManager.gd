...
func Action(UnitOnField: Array[Unit_blueprint], FriendlyUnitCounts: int, EnemiesUnitCounts: int):
	...
	var CurrentUnitsAction: Unit_blueprint
...
func CheckUnitAlive(UnitOnField: Array[Unit_blueprint], IsUnitFriendly_Target: bool):
...
func StartCombat():
	#Build both team
	var UnitOnField: Array[Unit_blueprint] = [calvin, TimmiesBird]
